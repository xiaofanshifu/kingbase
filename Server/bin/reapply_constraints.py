...
parser.add_argument('-d', '--drop_constraints', action="store_true", help="Drop all constraints managed by sys_partman. Drops constraints on all child tables including current & future.")
