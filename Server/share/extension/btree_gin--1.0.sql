...
CREATE INTERNAL FUNCTION gin_btree_consistent(internal, int2, anyelement, int4, internal, internal)
RETURNS bool
AS 'MODULE_PATHNAME','gin_btree_consistent'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_value_int2(int2, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_int2'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_int2(int2, int2, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_int2'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_int2(int2, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_int4(int4, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_int4'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_int4(int4, int4, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_int4'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_int4(int4, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_int8(int8, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_int8'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_int8(int8, int8, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_int8'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_int8(int8, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_float4(float4, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_float4'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_float4(float4, float4, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_float4'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_float4(float4, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_float8(float8, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_float8'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_float8(float8, float8, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_float8'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_float8(float8, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_money(money, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_money'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_money(money, money, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_money'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_money(money, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_oid(oid, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_oid'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_oid(oid, oid, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_oid'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_oid(oid, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_timestamp(timestamp, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_timestamp'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_timestamp(timestamp, timestamp, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_timestamp'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_timestamp(timestamp, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_timestamptz(timestamptz, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_timestamptz'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_timestamptz(timestamptz, timestamptz, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_timestamptz'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_timestamptz(timestamptz, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_time(time, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_time'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_time(time, time, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_time'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_time(time, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_timetz(timetz, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_timetz'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_timetz(timetz, timetz, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_timetz'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_timetz(timetz, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_date(date, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_date'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_date(date, date, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_date'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_date(date, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_interval(interval, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_interval'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_interval(interval, interval, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_interval'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_interval(interval, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_macaddr(macaddr, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_macaddr'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_macaddr(macaddr, macaddr, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_macaddr'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_macaddr(macaddr, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_inet(inet, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_inet'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_inet(inet, inet, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_inet'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_inet(inet, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_cidr(cidr, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_cidr'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_cidr(cidr, cidr, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_cidr'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_cidr(cidr, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_text(text, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_text'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_text(text, text, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_text'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_text(text, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_char("CHAR", internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_char'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_char("CHAR", "CHAR", int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_char'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_char("CHAR", internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_bytea(bytea, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_bytea'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_bytea(bytea, bytea, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_bytea'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_bytea(bytea, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_bit(bit, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_bit'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_bit(bit, bit, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_bit'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_bit(bit, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_varbit(varbit, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_varbit'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_varbit(varbit, varbit, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_varbit'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_varbit(varbit, internal, int2, internal, internal)
RETURNS internal
...
CREATE INTERNAL FUNCTION gin_extract_value_numeric(numeric, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_value_numeric'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_compare_prefix_numeric(numeric, numeric, int2, internal)
RETURNS int4
AS 'MODULE_PATHNAME','gin_compare_prefix_numeric'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_extract_query_numeric(numeric, internal, int2, internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gin_extract_query_numeric'
LANGUAGE C STRICT IMMUTABLE;

CREATE INTERNAL FUNCTION gin_numeric_cmp(numeric, numeric)
RETURNS int4
