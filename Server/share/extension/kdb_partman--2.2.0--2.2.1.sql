-- Fixed search path bug with run_maintenance() introduced in v2.2.0. Was causing errors if the sys_partman schema was not in the search path of the role calling it. (Github Issue #71)
