...
If you encounter this error, do the updates for 2.6.3 & 2.6.4 as follows:
    ...
    BEGIN;
    ALTER EXTENSION sys_partman UPDATE TO '2.6.3';
    COMMIT;

    BEGIN;
    ALTER EXTENSION sys_partman UPDATE TO '2.6.4';
    COMMIT;
*/
...
BEGIN
    ...
    FROM sys_catalog.sys_constraint t
    JOIN sys_catalog.sys_class c ON t.conrelid = c.oid
