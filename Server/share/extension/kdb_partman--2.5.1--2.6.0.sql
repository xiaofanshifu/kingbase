-- New function to aid in column removal: drop_partition_column(). 
    ...
    -- This function can work for any inheritance set to drop columns, not just those maintained by sys_partman.
 ...
 */
CREATE OR REPLACE INTERNAL FUNCTION drop_partition_column(p_parent_table text, p_column text) RETURNS void
