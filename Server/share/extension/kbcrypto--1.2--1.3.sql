/* contrib/kbcrypto/kbcrypto--1.2--1.3.sql */

-- complain if script is sourced in ksql, rather than via ALTER EXTENSION
\echo Use "ALTER EXTENSION kbcrypto UPDATE TO '1.3'" to load this file. \quit
...
-- sm4
ALTER FUNCTION sm4(bytea, bytea, int4) PARALLEL SAFE;
-- sm4_ex
ALTER FUNCTION sm4_ex(bytea, bytea, int4, int4) PARALLEL SAFE;
-- rc4
ALTER FUNCTION rc4(bytea, bytea, int4) PARALLEL SAFE;
