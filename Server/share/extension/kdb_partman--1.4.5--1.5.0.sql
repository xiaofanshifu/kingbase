 ...
 */
CREATE OR REPLACE INTERNAL FUNCTION apply_constraints(p_parent_table text, p_child_table text DEFAULT NULL, p_debug BOOLEAN DEFAULT FALSE) RETURNS void
    LANGUAGE plsql
    AS $$
DECLARE
 ...
 */
CREATE OR REPLACE INTERNAL FUNCTION drop_constraints(p_parent_table text, p_child_table text, p_debug boolean DEFAULT false) RETURNS void
    LANGUAGE plsql
    AS $$
DECLARE
 ...
 */
CREATE OR REPLACE INTERNAL FUNCTION show_partitions (p_parent_table text, p_order text DEFAULT 'ASC') RETURNS SETOF text
