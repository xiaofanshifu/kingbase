...
CREATE INTERNAL FUNCTION gbtreekey4_in(cstring)
RETURNS gbtreekey4
AS 'MODULE_PATHNAME', 'gbtreekey_in'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbtreekey4_out(gbtreekey4)
RETURNS cstring
...
CREATE INTERNAL FUNCTION gbtreekey8_in(cstring)
RETURNS gbtreekey8
AS 'MODULE_PATHNAME', 'gbtreekey_in'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbtreekey8_out(gbtreekey8)
RETURNS cstring
AS 'MODULE_PATHNAME', 'gbtreekey_out'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE INTERNAL FUNCTION gbtreekey16_in(cstring)
RETURNS gbtreekey16
AS 'MODULE_PATHNAME', 'gbtreekey_in'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbtreekey16_out(gbtreekey16)
RETURNS cstring
AS 'MODULE_PATHNAME', 'gbtreekey_out'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE INTERNAL FUNCTION gbtreekey32_in(cstring)
RETURNS gbtreekey32
AS 'MODULE_PATHNAME', 'gbtreekey_in'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbtreekey32_out(gbtreekey32)
RETURNS cstring
AS 'MODULE_PATHNAME', 'gbtreekey_out'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE INTERNAL FUNCTION gbtreekey_var_in(cstring)
RETURNS gbtreekey_var
AS 'MODULE_PATHNAME', 'gbtreekey_in'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbtreekey_var_out(gbtreekey_var)
RETURNS cstring
AS 'MODULE_PATHNAME', 'gbtreekey_out'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE INTERNAL FUNCTION cash_dist(money, money)
RETURNS money
...
CREATE INTERNAL FUNCTION date_dist(date, date)
RETURNS int4
...
CREATE INTERNAL FUNCTION float4_dist(float4, float4)
RETURNS float4
...
CREATE INTERNAL FUNCTION float8_dist(float8, float8)
RETURNS float8
...
CREATE INTERNAL FUNCTION int2_dist(int2, int2)
RETURNS int2
...
CREATE INTERNAL FUNCTION int4_dist(int4, int4)
RETURNS int4
...
CREATE INTERNAL FUNCTION int8_dist(int8, int8)
RETURNS int8
...
CREATE INTERNAL FUNCTION interval_dist(interval, interval)
RETURNS interval
...
CREATE INTERNAL FUNCTION oid_dist(oid, oid)
RETURNS oid
...
CREATE INTERNAL FUNCTION time_dist(time, time)
RETURNS interval
...
CREATE INTERNAL FUNCTION ts_dist(timestamp, timestamp)
RETURNS interval
...
CREATE INTERNAL FUNCTION tstz_dist(timestamptz, timestamptz)
RETURNS interval
...
CREATE INTERNAL FUNCTION gbt_oid_consistent(internal,oid,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_oid_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_oid_distance(internal,oid,int2,oid,internal)
RETURNS float8
AS 'MODULE_PATHNAME','gbt_oid_distance'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_oid_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_oid_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_oid_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_oid_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_decompress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_decompress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_var_decompress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_var_decompress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_var_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_var_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_oid_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_oid_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_oid_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_oid_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_oid_union(internal, internal)
RETURNS gbtreekey8
AS 'MODULE_PATHNAME','gbt_oid_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_oid_same(gbtreekey8, gbtreekey8, internal)
RETURNS internal
...
-- Add operators that are new in 8.0.  We do it like this, leaving them
-- "loose" in the operator family rather than bound into the opclass, because
-- that's the only state that can be reproduced during an upgrade from 8.0.
ALTER OPERATOR FAMILY gist_oid_ops USING gist ADD
	OPERATOR	6	<> (oid, oid) ,
	OPERATOR	15	<-> (oid, oid) FOR ORDER BY sys_catalog.oid_ops ,
	FUNCTION	8 (oid, oid) gbt_oid_distance (internal, oid, int2, oid, internal) ,
	-- Also add support function for index-only-scans, added in 8.2.
...
--
-- define the GiST support methods
CREATE INTERNAL FUNCTION gbt_int2_consistent(internal,int2,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_int2_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int2_distance(internal,int2,int2,oid,internal)
RETURNS float8
AS 'MODULE_PATHNAME','gbt_int2_distance'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int2_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_int2_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int2_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_int2_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int2_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_int2_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int2_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_int2_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int2_union(internal, internal)
RETURNS gbtreekey4
AS 'MODULE_PATHNAME','gbt_int2_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int2_same(gbtreekey4, gbtreekey4, internal)
RETURNS internal
...
ALTER OPERATOR FAMILY gist_int2_ops USING gist ADD
	...
	OPERATOR	15	<-> (int2, int2) FOR ORDER BY sys_catalog.integer_ops ,
...
--
-- define the GiST support methods
CREATE INTERNAL FUNCTION gbt_int4_consistent(internal,int4,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_int4_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int4_distance(internal,int4,int2,oid,internal)
RETURNS float8
AS 'MODULE_PATHNAME','gbt_int4_distance'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int4_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_int4_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int4_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_int4_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int4_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_int4_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int4_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_int4_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int4_union(internal, internal)
RETURNS gbtreekey8
AS 'MODULE_PATHNAME','gbt_int4_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int4_same(gbtreekey8, gbtreekey8, internal)
RETURNS internal
...
ALTER OPERATOR FAMILY gist_int4_ops USING gist ADD
	...
	OPERATOR	15	<-> (int4, int4) FOR ORDER BY sys_catalog.integer_ops ,
...
--
-- define the GiST support methods
CREATE INTERNAL FUNCTION gbt_int8_consistent(internal,int8,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_int8_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int8_distance(internal,int8,int2,oid,internal)
RETURNS float8
AS 'MODULE_PATHNAME','gbt_int8_distance'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int8_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_int8_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int8_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_int8_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int8_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_int8_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int8_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_int8_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int8_union(internal, internal)
RETURNS gbtreekey16
AS 'MODULE_PATHNAME','gbt_int8_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_int8_same(gbtreekey16, gbtreekey16, internal)
RETURNS internal
...
ALTER OPERATOR FAMILY gist_int8_ops USING gist ADD
	...
	OPERATOR	15	<-> (int8, int8) FOR ORDER BY sys_catalog.integer_ops ,
...
--
-- define the GiST support methods
CREATE INTERNAL FUNCTION gbt_float4_consistent(internal,float4,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_float4_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float4_distance(internal,float4,int2,oid,internal)
RETURNS float8
AS 'MODULE_PATHNAME','gbt_float4_distance'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float4_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_float4_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float4_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_float4_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float4_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_float4_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float4_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_float4_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float4_union(internal, internal)
RETURNS gbtreekey8
AS 'MODULE_PATHNAME','gbt_float4_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float4_same(gbtreekey8, gbtreekey8, internal)
RETURNS internal
...
ALTER OPERATOR FAMILY gist_float4_ops USING gist ADD
	...
	OPERATOR	15	<-> (float4, float4) FOR ORDER BY sys_catalog.float_ops ,
...
--
-- define the GiST support methods
CREATE INTERNAL FUNCTION gbt_float8_consistent(internal,float8,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_float8_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float8_distance(internal,float8,int2,oid,internal)
RETURNS float8
AS 'MODULE_PATHNAME','gbt_float8_distance'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float8_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_float8_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float8_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_float8_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float8_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_float8_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float8_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_float8_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float8_union(internal, internal)
RETURNS gbtreekey16
AS 'MODULE_PATHNAME','gbt_float8_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_float8_same(gbtreekey16, gbtreekey16, internal)
RETURNS internal
...
ALTER OPERATOR FAMILY gist_float8_ops USING gist ADD
	...
	OPERATOR	15	<-> (float8, float8) FOR ORDER BY sys_catalog.float_ops ,
...
CREATE INTERNAL FUNCTION gbt_ts_consistent(internal,timestamp,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_ts_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_ts_distance(internal,timestamp,int2,oid,internal)
RETURNS float8
AS 'MODULE_PATHNAME','gbt_ts_distance'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_tstz_consistent(internal,timestamptz,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_tstz_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_tstz_distance(internal,timestamptz,int2,oid,internal)
RETURNS float8
AS 'MODULE_PATHNAME','gbt_tstz_distance'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_ts_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_ts_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_tstz_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_tstz_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_ts_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_ts_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_ts_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_ts_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_ts_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_ts_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_ts_union(internal, internal)
RETURNS gbtreekey16
AS 'MODULE_PATHNAME','gbt_ts_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_ts_same(gbtreekey16, gbtreekey16, internal)
RETURNS internal
...
ALTER OPERATOR FAMILY gist_timestamp_ops USING gist ADD
	...
	OPERATOR	15	<-> (timestamp, timestamp) FOR ORDER BY sys_catalog.interval_ops ,
...
ALTER OPERATOR FAMILY gist_timestamptz_ops USING gist ADD
	...
	OPERATOR	15	<-> (timestamptz, timestamptz) FOR ORDER BY sys_catalog.interval_ops ,
...
CREATE INTERNAL FUNCTION gbt_time_consistent(internal,time,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_time_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_time_distance(internal,time,int2,oid,internal)
RETURNS float8
AS 'MODULE_PATHNAME','gbt_time_distance'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_timetz_consistent(internal,timetz,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_timetz_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_time_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_time_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_timetz_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_timetz_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_time_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_time_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_time_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_time_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_time_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_time_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_time_union(internal, internal)
RETURNS gbtreekey16
AS 'MODULE_PATHNAME','gbt_time_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_time_same(gbtreekey16, gbtreekey16, internal)
RETURNS internal
...
ALTER OPERATOR FAMILY gist_time_ops USING gist ADD
	...
	OPERATOR	15	<-> (time, time) FOR ORDER BY sys_catalog.interval_ops ,
...
CREATE INTERNAL FUNCTION gbt_date_consistent(internal,date,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_date_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_date_distance(internal,date,int2,oid,internal)
RETURNS float8
AS 'MODULE_PATHNAME','gbt_date_distance'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_date_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_date_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_date_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_date_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_date_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_date_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_date_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_date_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_date_union(internal, internal)
RETURNS gbtreekey8
AS 'MODULE_PATHNAME','gbt_date_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_date_same(gbtreekey8, gbtreekey8, internal)
RETURNS internal
...
ALTER OPERATOR FAMILY gist_date_ops USING gist ADD
	...
	OPERATOR	15	<-> (date, date) FOR ORDER BY sys_catalog.integer_ops ,
...
CREATE INTERNAL FUNCTION gbt_intv_consistent(internal,interval,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_intv_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_intv_distance(internal,interval,int2,oid,internal)
RETURNS float8
AS 'MODULE_PATHNAME','gbt_intv_distance'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_intv_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_intv_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_intv_decompress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_intv_decompress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_intv_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_intv_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_intv_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_intv_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_intv_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_intv_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_intv_union(internal, internal)
RETURNS gbtreekey32
AS 'MODULE_PATHNAME','gbt_intv_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_intv_same(gbtreekey32, gbtreekey32, internal)
RETURNS internal
...
ALTER OPERATOR FAMILY gist_interval_ops USING gist ADD
	...
	OPERATOR	15	<-> (interval, interval) FOR ORDER BY sys_catalog.interval_ops ,
...
--
-- define the GiST support methods
CREATE INTERNAL FUNCTION gbt_cash_consistent(internal,money,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_cash_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_cash_distance(internal,money,int2,oid,internal)
RETURNS float8
AS 'MODULE_PATHNAME','gbt_cash_distance'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_cash_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_cash_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_cash_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_cash_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_cash_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_cash_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_cash_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_cash_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_cash_union(internal, internal)
RETURNS gbtreekey16
AS 'MODULE_PATHNAME','gbt_cash_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_cash_same(gbtreekey16, gbtreekey16, internal)
RETURNS internal
...
ALTER OPERATOR FAMILY gist_cash_ops USING gist ADD
	...
	OPERATOR	15	<-> (money, money) FOR ORDER BY sys_catalog.money_ops ,
...
--
-- define the GiST support methods
CREATE INTERNAL FUNCTION gbt_macad_consistent(internal,macaddr,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_macad_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_macad_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_macad_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_macad_fetch(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_macad_fetch'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_macad_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_macad_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_macad_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_macad_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_macad_union(internal, internal)
RETURNS gbtreekey16
AS 'MODULE_PATHNAME','gbt_macad_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_macad_same(gbtreekey16, gbtreekey16, internal)
RETURNS internal
...
--
-- define the GiST support methods
CREATE INTERNAL FUNCTION gbt_text_consistent(internal,text,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_text_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_bpchar_consistent(internal,BPCHAR,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_bpchar_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_text_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_text_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_bpchar_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_bpchar_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_text_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_text_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_text_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_text_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_text_union(internal, internal)
RETURNS gbtreekey_var
AS 'MODULE_PATHNAME','gbt_text_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_text_same(gbtreekey_var, gbtreekey_var, internal)
RETURNS internal
...
--
-- define the GiST support methods
CREATE INTERNAL FUNCTION gbt_bytea_consistent(internal,bytea,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_bytea_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_bytea_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_bytea_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_bytea_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_bytea_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_bytea_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_bytea_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_bytea_union(internal, internal)
RETURNS gbtreekey_var
AS 'MODULE_PATHNAME','gbt_bytea_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_bytea_same(gbtreekey_var, gbtreekey_var, internal)
RETURNS internal
...
--
-- define the GiST support methods
CREATE INTERNAL FUNCTION gbt_numeric_consistent(internal,numeric,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_numeric_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_numeric_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_numeric_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_numeric_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_numeric_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_numeric_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_numeric_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_numeric_union(internal, internal)
RETURNS gbtreekey_var
AS 'MODULE_PATHNAME','gbt_numeric_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_numeric_same(gbtreekey_var, gbtreekey_var, internal)
RETURNS internal
...
--
-- define the GiST support methods
CREATE INTERNAL FUNCTION gbt_bit_consistent(internal,bit,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_bit_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_bit_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_bit_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_bit_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_bit_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_bit_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_bit_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_bit_union(internal, internal)
RETURNS gbtreekey_var
AS 'MODULE_PATHNAME','gbt_bit_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_bit_same(gbtreekey_var, gbtreekey_var, internal)
RETURNS internal
...
--
-- define the GiST support methods
CREATE INTERNAL FUNCTION gbt_inet_consistent(internal,inet,int2,oid,internal)
RETURNS bool
AS 'MODULE_PATHNAME','gbt_inet_consistent'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_inet_compress(internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_inet_compress'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_inet_penalty(internal,internal,internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_inet_penalty'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_inet_picksplit(internal, internal)
RETURNS internal
AS 'MODULE_PATHNAME','gbt_inet_picksplit'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_inet_union(internal, internal)
RETURNS gbtreekey16
AS 'MODULE_PATHNAME','gbt_inet_union'
LANGUAGE C IMMUTABLE STRICT;

CREATE INTERNAL FUNCTION gbt_inet_same(gbtreekey16, gbtreekey16, internal)
RETURNS internal
