...
-- Foreign key inheritance is now optional since more complex FK relationships may not work ideally with sys_partman's default method. New configuration option in part_config table and parameter to create_parent().
