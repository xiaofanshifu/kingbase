...
CREATE OR REPLACE INTERNAL FUNCTION ascii_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/ascii_and_mic', 'ascii_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.ascii_to_mic IS 'conversion for SQL_ASCII to MULE_INTERNAL';

-- MULE_INTERNAL --> SQL_ASCII
CREATE OR REPLACE INTERNAL FUNCTION mic_to_ascii (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/ascii_and_mic', 'mic_to_ascii' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_ascii IS 'conversion for MULE_INTERNAL to SQL_ASCII';

-- KOI8R --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION koi8r_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'koi8r_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.koi8_r_to_mic IS 'conversion for KOI8R to MULE_INTERNAL';

-- MULE_INTERNAL --> KOI8R
CREATE OR REPLACE INTERNAL FUNCTION mic_to_koi8r (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'mic_to_koi8r' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_koi8_r IS 'conversion for MULE_INTERNAL to KOI8R';

-- ISO-8859-5 --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION iso_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'iso_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.iso_8859_5_to_mic IS 'conversion for ISO-8859-5 to MULE_INTERNAL';

-- MULE_INTERNAL --> ISO-8859-5
CREATE OR REPLACE INTERNAL FUNCTION mic_to_iso (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'mic_to_iso' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_iso_8859_5 IS 'conversion for MULE_INTERNAL to ISO-8859-5';

-- WIN1251 --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION win1251_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'win1251_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.windows_1251_to_mic IS 'conversion for WIN1251 to MULE_INTERNAL';

-- MULE_INTERNAL --> WIN1251
CREATE OR REPLACE INTERNAL FUNCTION mic_to_win1251 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'mic_to_win1251' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_windows_1251 IS 'conversion for MULE_INTERNAL to WIN1251';

-- WIN866 --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION win866_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'win866_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.windows_866_to_mic IS 'conversion for WIN866 to MULE_INTERNAL';

-- MULE_INTERNAL --> WIN866
CREATE OR REPLACE INTERNAL FUNCTION mic_to_win866 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'mic_to_win866' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_windows_866 IS 'conversion for MULE_INTERNAL to WIN866';

-- KOI8R --> WIN1251
CREATE OR REPLACE INTERNAL FUNCTION koi8r_to_win1251 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'koi8r_to_win1251' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.koi8_r_to_windows_1251 IS 'conversion for KOI8R to WIN1251';

-- WIN1251 --> KOI8R
CREATE OR REPLACE INTERNAL FUNCTION win1251_to_koi8r (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'win1251_to_koi8r' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.windows_1251_to_koi8_r IS 'conversion for WIN1251 to KOI8R';

-- KOI8R --> WIN866
CREATE OR REPLACE INTERNAL FUNCTION koi8r_to_win866 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'koi8r_to_win866' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.koi8_r_to_windows_866 IS 'conversion for KOI8R to WIN866';

-- WIN866 --> KOI8R
CREATE OR REPLACE INTERNAL FUNCTION win866_to_koi8r (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'win866_to_koi8r' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.windows_866_to_koi8_r IS 'conversion for WIN866 to KOI8R';

-- WIN866 --> WIN1251
CREATE OR REPLACE INTERNAL FUNCTION win866_to_win1251 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'win866_to_win1251' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.windows_866_to_windows_1251 IS 'conversion for WIN866 to WIN1251';

-- WIN1251 --> WIN866
CREATE OR REPLACE INTERNAL FUNCTION win1251_to_win866 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'win1251_to_win866' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.windows_1251_to_windows_866 IS 'conversion for WIN1251 to WIN866';

-- ISO-8859-5 --> KOI8R
CREATE OR REPLACE INTERNAL FUNCTION iso_to_koi8r (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'iso_to_koi8r' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.iso_8859_5_to_koi8_r IS 'conversion for ISO-8859-5 to KOI8R';

-- KOI8R --> ISO-8859-5
CREATE OR REPLACE INTERNAL FUNCTION koi8r_to_iso (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'koi8r_to_iso' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.koi8_r_to_iso_8859_5 IS 'conversion for KOI8R to ISO-8859-5';

-- ISO-8859-5 --> WIN1251
CREATE OR REPLACE INTERNAL FUNCTION iso_to_win1251 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'iso_to_win1251' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.iso_8859_5_to_windows_1251 IS 'conversion for ISO-8859-5 to WIN1251';

-- WIN1251 --> ISO-8859-5
CREATE OR REPLACE INTERNAL FUNCTION win1251_to_iso (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'win1251_to_iso' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.windows_1251_to_iso_8859_5 IS 'conversion for WIN1251 to ISO-8859-5';

-- ISO-8859-5 --> WIN866
CREATE OR REPLACE INTERNAL FUNCTION iso_to_win866 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'iso_to_win866' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.iso_8859_5_to_windows_866 IS 'conversion for ISO-8859-5 to WIN866';

-- WIN866 --> ISO-8859-5
CREATE OR REPLACE INTERNAL FUNCTION win866_to_iso (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/cyrillic_and_mic', 'win866_to_iso' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.windows_866_to_iso_8859_5 IS 'conversion for WIN866 to ISO-8859-5';

-- EUC_CN --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION euc_cn_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_cn_and_mic', 'euc_cn_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.euc_cn_to_mic IS 'conversion for EUC_CN to MULE_INTERNAL';

-- MULE_INTERNAL --> EUC_CN
CREATE OR REPLACE INTERNAL FUNCTION mic_to_euc_cn (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_cn_and_mic', 'mic_to_euc_cn' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_euc_cn IS 'conversion for MULE_INTERNAL to EUC_CN';

-- EUC_JP --> SJIS
CREATE OR REPLACE INTERNAL FUNCTION euc_jp_to_sjis (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_jp_and_sjis', 'euc_jp_to_sjis' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.euc_jp_to_sjis IS 'conversion for EUC_JP to SJIS';

-- SJIS --> EUC_JP
CREATE OR REPLACE INTERNAL FUNCTION sjis_to_euc_jp (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_jp_and_sjis', 'sjis_to_euc_jp' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.sjis_to_euc_jp IS 'conversion for SJIS to EUC_JP';

-- EUC_JP --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION euc_jp_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_jp_and_sjis', 'euc_jp_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.euc_jp_to_mic IS 'conversion for EUC_JP to MULE_INTERNAL';

-- SJIS --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION sjis_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_jp_and_sjis', 'sjis_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.sjis_to_mic IS 'conversion for SJIS to MULE_INTERNAL';

-- MULE_INTERNAL --> EUC_JP
CREATE OR REPLACE INTERNAL FUNCTION mic_to_euc_jp (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_jp_and_sjis', 'mic_to_euc_jp' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_euc_jp IS 'conversion for MULE_INTERNAL to EUC_JP';

-- MULE_INTERNAL --> SJIS
CREATE OR REPLACE INTERNAL FUNCTION mic_to_sjis (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_jp_and_sjis', 'mic_to_sjis' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_sjis IS 'conversion for MULE_INTERNAL to SJIS';

-- EUC_KR --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION euc_kr_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_kr_and_mic', 'euc_kr_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.euc_kr_to_mic IS 'conversion for EUC_KR to MULE_INTERNAL';

-- MULE_INTERNAL --> EUC_KR
CREATE OR REPLACE INTERNAL FUNCTION mic_to_euc_kr (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_kr_and_mic', 'mic_to_euc_kr' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_euc_kr IS 'conversion for MULE_INTERNAL to EUC_KR';

-- EUC_TW --> BIG5
CREATE OR REPLACE INTERNAL FUNCTION euc_tw_to_big5 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_tw_and_big5', 'euc_tw_to_big5' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.euc_tw_to_big5 IS 'conversion for EUC_TW to BIG5';

-- BIG5 --> EUC_TW
CREATE OR REPLACE INTERNAL FUNCTION big5_to_euc_tw (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_tw_and_big5', 'big5_to_euc_tw' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.big5_to_euc_tw IS 'conversion for BIG5 to EUC_TW';

-- EUC_TW --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION euc_tw_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_tw_and_big5', 'euc_tw_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.euc_tw_to_mic IS 'conversion for EUC_TW to MULE_INTERNAL';

-- BIG5 --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION big5_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_tw_and_big5', 'big5_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.big5_to_mic IS 'conversion for BIG5 to MULE_INTERNAL';

-- MULE_INTERNAL --> EUC_TW
CREATE OR REPLACE INTERNAL FUNCTION mic_to_euc_tw (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_tw_and_big5', 'mic_to_euc_tw' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_euc_tw IS 'conversion for MULE_INTERNAL to EUC_TW';

-- MULE_INTERNAL --> BIG5
CREATE OR REPLACE INTERNAL FUNCTION mic_to_big5 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc_tw_and_big5', 'mic_to_big5' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_big5 IS 'conversion for MULE_INTERNAL to BIG5';

-- LATIN2 --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION latin2_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/latin2_and_win1250', 'latin2_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.iso_8859_2_to_mic IS 'conversion for LATIN2 to MULE_INTERNAL';

-- MULE_INTERNAL --> LATIN2
CREATE OR REPLACE INTERNAL FUNCTION mic_to_latin2 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/latin2_and_win1250', 'mic_to_latin2' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_iso_8859_2 IS 'conversion for MULE_INTERNAL to LATIN2';

-- WIN1250 --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION win1250_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/latin2_and_win1250', 'win1250_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.windows_1250_to_mic IS 'conversion for WIN1250 to MULE_INTERNAL';

-- MULE_INTERNAL --> WIN1250
CREATE OR REPLACE INTERNAL FUNCTION mic_to_win1250 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/latin2_and_win1250', 'mic_to_win1250' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_windows_1250 IS 'conversion for MULE_INTERNAL to WIN1250';

-- LATIN2 --> WIN1250
CREATE OR REPLACE INTERNAL FUNCTION latin2_to_win1250 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/latin2_and_win1250', 'latin2_to_win1250' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.iso_8859_2_to_windows_1250 IS 'conversion for LATIN2 to WIN1250';

-- WIN1250 --> LATIN2
CREATE OR REPLACE INTERNAL FUNCTION win1250_to_latin2 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/latin2_and_win1250', 'win1250_to_latin2' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.windows_1250_to_iso_8859_2 IS 'conversion for WIN1250 to LATIN2';

-- LATIN1 --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION latin1_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/latin_and_mic', 'latin1_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.iso_8859_1_to_mic IS 'conversion for LATIN1 to MULE_INTERNAL';

-- MULE_INTERNAL --> LATIN1
CREATE OR REPLACE INTERNAL FUNCTION mic_to_latin1 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/latin_and_mic', 'mic_to_latin1' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_iso_8859_1 IS 'conversion for MULE_INTERNAL to LATIN1';

-- LATIN3 --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION latin3_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/latin_and_mic', 'latin3_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.iso_8859_3_to_mic IS 'conversion for LATIN3 to MULE_INTERNAL';

-- MULE_INTERNAL --> LATIN3
CREATE OR REPLACE INTERNAL FUNCTION mic_to_latin3 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/latin_and_mic', 'mic_to_latin3' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_iso_8859_3 IS 'conversion for MULE_INTERNAL to LATIN3';

-- LATIN4 --> MULE_INTERNAL
CREATE OR REPLACE INTERNAL FUNCTION latin4_to_mic (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/latin_and_mic', 'latin4_to_mic' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.iso_8859_4_to_mic IS 'conversion for LATIN4 to MULE_INTERNAL';

-- MULE_INTERNAL --> LATIN4
CREATE OR REPLACE INTERNAL FUNCTION mic_to_latin4 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/latin_and_mic', 'mic_to_latin4' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.mic_to_iso_8859_4 IS 'conversion for MULE_INTERNAL to LATIN4';

-- SQL_ASCII --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION ascii_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_ascii', 'ascii_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.ascii_to_utf8 IS 'conversion for SQL_ASCII to UTF8';

-- UTF8 --> SQL_ASCII
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_ascii (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_ascii', 'utf8_to_ascii' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_ascii IS 'conversion for UTF8 to SQL_ASCII';

-- BIG5 --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION big5_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_big5', 'big5_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.big5_to_utf8 IS 'conversion for BIG5 to UTF8';

-- UTF8 --> BIG5
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_big5 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_big5', 'utf8_to_big5' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_big5 IS 'conversion for UTF8 to BIG5';

-- UTF8 --> KOI8R
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_koi8r (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_cyrillic', 'utf8_to_koi8r' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_koi8_r IS 'conversion for UTF8 to KOI8R';

-- KOI8R --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION koi8r_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_cyrillic', 'koi8r_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.koi8_r_to_utf8 IS 'conversion for KOI8R to UTF8';

-- UTF8 --> KOI8U
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_koi8u (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_cyrillic', 'utf8_to_koi8u' LANGUAGE C STRICT PARALLEL SAFE;
...
DROP CONVERSION sys_catalog.utf8_to_koi8_u;
CREATE DEFAULT CONVERSION sys_catalog.utf8_to_koi8_u FOR 'UTF8' TO 'KOI8U' FROM utf8_to_koi8u;
COMMENT ON CONVERSION sys_catalog.utf8_to_koi8_u IS 'conversion for UTF8 to KOI8U';

-- KOI8U --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION koi8u_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_cyrillic', 'koi8u_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
DROP CONVERSION sys_catalog.koi8_u_to_utf8;
CREATE DEFAULT CONVERSION sys_catalog.koi8_u_to_utf8 FOR 'KOI8U' TO 'UTF8' FROM koi8u_to_utf8;
COMMENT ON CONVERSION sys_catalog.koi8_u_to_utf8 IS 'conversion for KOI8U to UTF8';

-- UTF8 --> WIN866
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_win (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'utf8_to_win' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_windows_866 IS 'conversion for UTF8 to WIN866';

-- WIN866 --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION win_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_win', 'win_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.windows_866_to_utf8 IS 'conversion for WIN866 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_windows_874 IS 'conversion for UTF8 to WIN874';
...
COMMENT ON CONVERSION sys_catalog.windows_874_to_utf8 IS 'conversion for WIN874 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_windows_1250 IS 'conversion for UTF8 to WIN1250';
...
COMMENT ON CONVERSION sys_catalog.windows_1250_to_utf8 IS 'conversion for WIN1250 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_windows_1251 IS 'conversion for UTF8 to WIN1251';
...
COMMENT ON CONVERSION sys_catalog.windows_1251_to_utf8 IS 'conversion for WIN1251 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_windows_1252 IS 'conversion for UTF8 to WIN1252';
...
COMMENT ON CONVERSION sys_catalog.windows_1252_to_utf8 IS 'conversion for WIN1252 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_windows_1253 IS 'conversion for UTF8 to WIN1253';
...
COMMENT ON CONVERSION sys_catalog.windows_1253_to_utf8 IS 'conversion for WIN1253 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_windows_1254 IS 'conversion for UTF8 to WIN1254';
...
COMMENT ON CONVERSION sys_catalog.windows_1254_to_utf8 IS 'conversion for WIN1254 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_windows_1255 IS 'conversion for UTF8 to WIN1255';
...
COMMENT ON CONVERSION sys_catalog.windows_1255_to_utf8 IS 'conversion for WIN1255 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_windows_1256 IS 'conversion for UTF8 to WIN1256';
...
COMMENT ON CONVERSION sys_catalog.windows_1256_to_utf8 IS 'conversion for WIN1256 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_windows_1257 IS 'conversion for UTF8 to WIN1257';
...
COMMENT ON CONVERSION sys_catalog.windows_1257_to_utf8 IS 'conversion for WIN1257 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_windows_1258 IS 'conversion for UTF8 to WIN1258';
...
COMMENT ON CONVERSION sys_catalog.windows_1258_to_utf8 IS 'conversion for WIN1258 to UTF8';

-- EUC_CN --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION euc_cn_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_euc_cn', 'euc_cn_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.euc_cn_to_utf8 IS 'conversion for EUC_CN to UTF8';

-- UTF8 --> EUC_CN
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_euc_cn (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_euc_cn', 'utf8_to_euc_cn' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_euc_cn IS 'conversion for UTF8 to EUC_CN';

-- EUC_JP --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION euc_jp_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_euc_jp', 'euc_jp_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.euc_jp_to_utf8 IS 'conversion for EUC_JP to UTF8';

-- UTF8 --> EUC_JP
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_euc_jp (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_euc_jp', 'utf8_to_euc_jp' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_euc_jp IS 'conversion for UTF8 to EUC_JP';

-- EUC_KR --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION euc_kr_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_euc_kr', 'euc_kr_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.euc_kr_to_utf8 IS 'conversion for EUC_KR to UTF8';

-- UTF8 --> EUC_KR
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_euc_kr (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_euc_kr', 'utf8_to_euc_kr' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_euc_kr IS 'conversion for UTF8 to EUC_KR';

-- EUC_TW --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION euc_tw_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_euc_tw', 'euc_tw_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.euc_tw_to_utf8 IS 'conversion for EUC_TW to UTF8';

-- UTF8 --> EUC_TW
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_euc_tw (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_euc_tw', 'utf8_to_euc_tw' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_euc_tw IS 'conversion for UTF8 to EUC_TW';

-- GB18030 --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION gb18030_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_gb18030', 'gb18030_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.gb18030_to_utf8 IS 'conversion for GB18030 to UTF8';

-- UTF8 --> GB18030
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_gb18030 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_gb18030', 'utf8_to_gb18030' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_gb18030 IS 'conversion for UTF8 to GB18030';

-- GBK --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION gbk_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_gbk', 'gbk_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.gbk_to_utf8 IS 'conversion for GBK to UTF8';

-- UTF8 --> GBK
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_gbk (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_gbk', 'utf8_to_gbk' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_gbk IS 'conversion for UTF8 to GBK';

-- GBK --> GB18030
CREATE OR REPLACE INTERNAL FUNCTION gbk_to_gb18030 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/gbk_and_gb18030', 'gbk_to_gb18030' LANGUAGE C STRICT PARALLEL SAFE;
COMMENT ON FUNCTION gbk_to_gb18030(INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) IS 'internal conversion function for GBK to GB18030';
...
COMMENT ON CONVERSION sys_catalog.gbk_to_gb18030 IS 'conversion for GBK to GB18030';

-- GB18030 --> GBK
CREATE OR REPLACE INTERNAL FUNCTION gb18030_to_gbk (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/gbk_and_gb18030', 'gb18030_to_gbk' LANGUAGE C STRICT PARALLEL SAFE;
COMMENT ON FUNCTION gb18030_to_gbk(INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) IS 'internal conversion function for GB18030 to GBK';
...
COMMENT ON CONVERSION sys_catalog.gb18030_to_gbk IS 'conversion for GB18030 to GBK';

-- UTF8 --> LATIN2
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_iso8859 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'utf8_to_iso8859' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_2 IS 'conversion for UTF8 to LATIN2';

-- LATIN2 --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION iso8859_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859', 'iso8859_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.iso_8859_2_to_utf8 IS 'conversion for LATIN2 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_3 IS 'conversion for UTF8 to LATIN3';
...
COMMENT ON CONVERSION sys_catalog.iso_8859_3_to_utf8 IS 'conversion for LATIN3 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_4 IS 'conversion for UTF8 to LATIN4';
...
COMMENT ON CONVERSION sys_catalog.iso_8859_4_to_utf8 IS 'conversion for LATIN4 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_9 IS 'conversion for UTF8 to LATIN5';
...
COMMENT ON CONVERSION sys_catalog.iso_8859_9_to_utf8 IS 'conversion for LATIN5 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_10 IS 'conversion for UTF8 to LATIN6';
...
COMMENT ON CONVERSION sys_catalog.iso_8859_10_to_utf8 IS 'conversion for LATIN6 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_13 IS 'conversion for UTF8 to LATIN7';
...
COMMENT ON CONVERSION sys_catalog.iso_8859_13_to_utf8 IS 'conversion for LATIN7 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_14 IS 'conversion for UTF8 to LATIN8';
...
COMMENT ON CONVERSION sys_catalog.iso_8859_14_to_utf8 IS 'conversion for LATIN8 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_15 IS 'conversion for UTF8 to LATIN9';
...
COMMENT ON CONVERSION sys_catalog.iso_8859_15_to_utf8 IS 'conversion for LATIN9 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_16 IS 'conversion for UTF8 to LATIN10';
...
COMMENT ON CONVERSION sys_catalog.iso_8859_16_to_utf8 IS 'conversion for LATIN10 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_5 IS 'conversion for UTF8 to ISO-8859-5';
...
COMMENT ON CONVERSION sys_catalog.iso_8859_5_to_utf8 IS 'conversion for ISO-8859-5 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_6 IS 'conversion for UTF8 to ISO-8859-6';
...
COMMENT ON CONVERSION sys_catalog.iso_8859_6_to_utf8 IS 'conversion for ISO-8859-6 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_7 IS 'conversion for UTF8 to ISO-8859-7';
...
COMMENT ON CONVERSION sys_catalog.iso_8859_7_to_utf8 IS 'conversion for ISO-8859-7 to UTF8';
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_8 IS 'conversion for UTF8 to ISO-8859-8';
...
COMMENT ON CONVERSION sys_catalog.iso_8859_8_to_utf8 IS 'conversion for ISO-8859-8 to UTF8';

-- LATIN1 --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION iso8859_1_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859_1', 'iso8859_1_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.iso_8859_1_to_utf8 IS 'conversion for LATIN1 to UTF8';

-- UTF8 --> LATIN1
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_iso8859_1 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_iso8859_1', 'utf8_to_iso8859_1' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_iso_8859_1 IS 'conversion for UTF8 to LATIN1';

-- JOHAB --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION johab_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_johab', 'johab_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.johab_to_utf8 IS 'conversion for JOHAB to UTF8';

-- UTF8 --> JOHAB
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_johab (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_johab', 'utf8_to_johab' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_johab IS 'conversion for UTF8 to JOHAB';

-- SJIS --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION sjis_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_sjis', 'sjis_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.sjis_to_utf8 IS 'conversion for SJIS to UTF8';

-- UTF8 --> SJIS
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_sjis (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_sjis', 'utf8_to_sjis' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_sjis IS 'conversion for UTF8 to SJIS';

-- UHC --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION uhc_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_uhc', 'uhc_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.uhc_to_utf8 IS 'conversion for UHC to UTF8';

-- UTF8 --> UHC
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_uhc (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_uhc', 'utf8_to_uhc' LANGUAGE C STRICT PARALLEL SAFE;
...
COMMENT ON CONVERSION sys_catalog.utf8_to_uhc IS 'conversion for UTF8 to UHC';

-- EUC_JIS_2004 --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION euc_jis_2004_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_euc2004', 'euc_jis_2004_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
DROP CONVERSION sys_catalog.euc_jis_2004_to_utf8;
CREATE DEFAULT CONVERSION sys_catalog.euc_jis_2004_to_utf8 FOR 'EUC_JIS_2004' TO 'UTF8' FROM euc_jis_2004_to_utf8;
COMMENT ON CONVERSION sys_catalog.euc_jis_2004_to_utf8 IS 'conversion for EUC_JIS_2004 to UTF8';

-- UTF8 --> EUC_JIS_2004
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_euc_jis_2004 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_euc2004', 'utf8_to_euc_jis_2004' LANGUAGE C STRICT PARALLEL SAFE;
...
DROP CONVERSION sys_catalog.utf8_to_euc_jis_2004;
CREATE DEFAULT CONVERSION sys_catalog.utf8_to_euc_jis_2004 FOR 'UTF8' TO 'EUC_JIS_2004' FROM utf8_to_euc_jis_2004;
COMMENT ON CONVERSION sys_catalog.utf8_to_euc_jis_2004 IS 'conversion for UTF8 to EUC_JIS_2004';

-- SHIFT_JIS_2004 --> UTF8
CREATE OR REPLACE INTERNAL FUNCTION shift_jis_2004_to_utf8 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_sjis2004', 'shift_jis_2004_to_utf8' LANGUAGE C STRICT PARALLEL SAFE;
...
DROP CONVERSION sys_catalog.shift_jis_2004_to_utf8;
CREATE DEFAULT CONVERSION sys_catalog.shift_jis_2004_to_utf8 FOR 'SHIFT_JIS_2004' TO 'UTF8' FROM shift_jis_2004_to_utf8;
COMMENT ON CONVERSION sys_catalog.shift_jis_2004_to_utf8 IS 'conversion for SHIFT_JIS_2004 to UTF8';

-- UTF8 --> SHIFT_JIS_2004
CREATE OR REPLACE INTERNAL FUNCTION utf8_to_shift_jis_2004 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/utf8_and_sjis2004', 'utf8_to_shift_jis_2004' LANGUAGE C STRICT PARALLEL SAFE;
...
DROP CONVERSION sys_catalog.utf8_to_shift_jis_2004;
CREATE DEFAULT CONVERSION sys_catalog.utf8_to_shift_jis_2004 FOR 'UTF8' TO 'SHIFT_JIS_2004' FROM utf8_to_shift_jis_2004;
COMMENT ON CONVERSION sys_catalog.utf8_to_shift_jis_2004 IS 'conversion for UTF8 to SHIFT_JIS_2004';

-- EUC_JIS_2004 --> SHIFT_JIS_2004
CREATE OR REPLACE INTERNAL FUNCTION euc_jis_2004_to_shift_jis_2004 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc2004_sjis2004', 'euc_jis_2004_to_shift_jis_2004' LANGUAGE C STRICT PARALLEL SAFE;
...
DROP CONVERSION sys_catalog.euc_jis_2004_to_shift_jis_2004;
CREATE DEFAULT CONVERSION sys_catalog.euc_jis_2004_to_shift_jis_2004 FOR 'EUC_JIS_2004' TO 'SHIFT_JIS_2004' FROM euc_jis_2004_to_shift_jis_2004;
COMMENT ON CONVERSION sys_catalog.euc_jis_2004_to_shift_jis_2004 IS 'conversion for EUC_JIS_2004 to SHIFT_JIS_2004';

-- SHIFT_JIS_2004 --> EUC_JIS_2004
CREATE OR REPLACE INTERNAL FUNCTION shift_jis_2004_to_euc_jis_2004 (INTEGER, INTEGER, CSTRING, INTERNAL, INTEGER) RETURNS VOID AS '$libdir/euc2004_sjis2004', 'shift_jis_2004_to_euc_jis_2004' LANGUAGE C STRICT PARALLEL SAFE;
...
DROP CONVERSION sys_catalog.shift_jis_2004_to_euc_jis_2004;
CREATE DEFAULT CONVERSION sys_catalog.shift_jis_2004_to_euc_jis_2004 FOR 'SHIFT_JIS_2004' TO 'EUC_JIS_2004' FROM shift_jis_2004_to_euc_jis_2004;
COMMENT ON CONVERSION sys_catalog.shift_jis_2004_to_euc_jis_2004 IS 'conversion for SHIFT_JIS_2004 to EUC_JIS_2004';
