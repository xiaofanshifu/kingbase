 ...
 *
 * Copyright (c) 2007-2016, Kingbase Corporation
 *
...
CREATE INTERNAL FUNCTION dsnowball_init(INTERNAL)
    RETURNS INTERNAL AS '$libdir/dict_snowball', 'dsnowball_init'
LANGUAGE C STRICT;

CREATE INTERNAL FUNCTION dsnowball_lexize(INTERNAL, INTERNAL, INTERNAL, INTERNAL)
